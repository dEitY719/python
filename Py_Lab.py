...
##print("공백 개수:", space_count) ## 공백 개수: 10
...
##
### 코드 작성
##total = int(int(p) + int(p) * float(t) / 100)//1000 * 1000
##print( total )
...
############################################################
## [4101] B9: PY0 [LAB] 문자열 2개 입력 받아서 연결하기
############################################################
##a = input()
##b = input()
##c = a + " " + b
...
############################################################
## [3786] C4: PY2 [4-9] 문자열과 정수 2개를 입력 받는 코드
############################################################
##s = input()
##a, b = str.split(input())
##                 
...
############################################################
## [3787] C5: PY2 [4-10] 이름, 키, 나이를 입력 받아 인쇄하기
############################################################
##a, b, c = input().split()
##b = float(b)
##c = int(c)
...
##a, b, c = input("enter 3 strings >> ")
##print( a, b, c )

'''
enter 3 strings >> kim lee park

ValueError: too many values to unpack (expected 3)

"kim lee park" 이 너무 많은 12개의 values 이다. 
'''
...
##a, b = input("Enter 2 integer >> ").split()
##print(type(a), type(b))
##
##a, b = int(a), int(b)
##print( a + b )
...
############################################################
## [4104] C6: PY0 [LAB] 한 줄에 2개의 문자열을 받아서 연결하기
############################################################
##a, b = input().split()
##print(a+b)
...
############################################################
## [4105] C7: PY0 [LAB] 한 줄로 문자열과 숫자 받아서 반복하기
############################################################
##a, b = input().split()
##print(a*int(b))
...
##[3715] D0: PY2 [4-15] ,로 분리된 여러 정수 입력 받기
############################################################
...
##[3716] D1: PY2 [4-16] 여러 줄로 입력되는 값 받기
############################################################
##a = int(input())
...
############################################################
# [4-17] 몫과 나머지 계산
## [4103] C1: PY0 [LAB] 정수 2개 입력 받아 몫과 나머지 구하기
############################################################

##dividend = int(input())
##divisor = int(input())
##dividend, divisor = map( int, input('Enter mod() 2 numbers >> ').split() )
####
...
# [4-18] 문자열 반복 인쇄
############################################################
##s, n = input("String X Number : Enter word, number").split(sep=',')
##s, n = input().split()
##c = s * int(n)
##print(c)

############################################################
## [4102] C0: PY0 [LAB] 문자열과 숫자 받아서 반복하기
############################################################
##s = input()
##n = input()
##c = s * int(n)
...
### 코드 작성
##price, rate = map(float, input('Enter price rate').split() )
##tax = price * (rate / 100)
##total = price + tax
##
##print("tax=", tax)
...
##[3721] D5: PY2 [4-20] 세개의 정수들의 합계와 평균
############################################################
...
############################################################
##[4107] D6: PY0 [LAB] 3명의 키 분석
# input > 180.4 178.5 160
############################################################
...
# a, b, c = map(float, input("3명의 키 입력 >> ").split())
...
############################################################
# [4108] D7: PY0 [LAB] 생수 생산
# input 3 400 (w=3L, b=400ml)
# output 400ml * x병 + y ml(remain) = 3L
############################################################
# TODO
# w, b = map(int, input("W, B 입력 >>").split())
# totalW = w * 1000
# bN = totalW // b
# remain = totalW % b
# print( bN, remain)
...
# input >> 10 20 30
# input >> 10 20 10  !! 중복된 값을 입력하면 set의 결과는?
############################################################
...
# t = map(int, input().split())
# print(sum(t)) # 15
# print(sum(t)) # 0  due to `소진`

############################################################
# [6-10] 실수들의 합과 평균 구하기
# [3788] E1: PY2 [6-10] 실수들의 합과 평균 구하기
# input >> 3.14  5.59  10
############################################################
# n = int(input())
...
# # c[0] = 'K' # str is immutable
# # TypeError: 'str' object does not support item assignment
# # t[1] = 5.125 # tuple is immutable
...
# # 코드 작성
# _loc, _friend = input().split()
# _loc = int(_loc)

# l.insert(_loc-1, _friend)

# print(l)

############################################################
# [4109] E3: PY0 [LAB] 경품 선택
############################################################
...
############################################################
# [4111] E5: PY0 [LAB] 이름 바꾸기
############################################################
 

############################################################
# [4110] E4: PY0 [LAB] 학생별 몸무게 정보 확인 프로그램
############################################################
# weight = {'kim':80,'lee':75,'park':89.3,'song':72,'lew':90}
# choice = input()
# # print(choice,"=>",weight[choice])
# print(weight[choice])
...
# l2 = [['a',10],['c',20],['c',40]] # 이미 존재하는 'c'는 갱신
# t2 = (('a',10),('a',5),('c',40)) # 이미 존재하는 'a'는 갱신
...
# d = dict(a = 10, b = 3.5, xy = 'kim') # !! 독특한 dict 생성
# print(d)
# print('- '*20)
...
# print(*x, sep='\n')
# # {'a': 1, 'b': 2, 3: 'c'}
# # set 의 쌍이 dict는 되는데, set은 순서 보장 X
# # So, key, value의 순서가 보장 안됨
# # 3:'c'의 결과를 보시라!


############################################################
# [4112] E9: PY0 [LAB] 좌표의 값
############################################################
...
# # 코드 작성
# l = list(t)
# n, friend = input().split()
# l.insert(int(n)-1, friend)
...
############################################################
# [4123] G5: PY0 [LAB] 16진수를 입력하면 10진수로 변환하여 인쇄하기
############################################################
...
############################################################
# [4178] I9: PY0 [LAB] 나보다 키큰 학생은 몇 명일까?
# input >> 120.1 180.5 178 190.5 178 178 180.5 170 180.5 178
############################################################
...
############################################################
# [4137] K7: PY0 [LAB] 0으로 초기화된 리스트 만들기
############################################################
...
##
##ar = round(sum(r)/len(r))
##ag = round(sum(g)/len(g))
##ab = round(sum(b)/len(b))
##
##print("0x%x 0x%x 0x%x" % (ar, ag, ab))
...
############################################################
# [27-7-2] 연산자와 Built-In 함수 Overloading
############################################################
...
############################################################
# [27-8-1] Child Class 생성과 상속(Inheritance)
############################################################
...
############################################################
# [27-9] Class method, Static method
############################################################
...
############################################################
# [7422] I6: [python test] 과일의 종류 구하기
# input >> mango,melon,banana,mango,pear,apple,banana,orange
############################################################

# argv = input().split(sep=',')
# s = set(argv)
# print(len(s))
# # l = list(s)
# # print(l, len(l))
...
############################################################
# [7423] I7: [python test] 첫 글자 뒤에 $ 추가하기
# input >> hello python Willtek Korea embedded world
############################################################
# 
# def func(s1, s2) :
#    return s1[0] + s2 + s1[1:]
...
# out = [func(x, '$') for x in argv]
# print(*out)

############################################################
# [7424] I8: [python test] 제일 키큰 친구 앞에 줄서기
# input >> 167.2 180.1 179.0 169.5
############################################################
# 
# myHeight = float(input())
# argv = map(float, input().split())
# l = list(argv)
# highest_idx = l.index(max(l))
# # print(l[highest_idx], highest_idx)
# l.insert(highest_idx, myHeight)
# print(*l)
